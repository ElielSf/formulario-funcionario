...
export default function Form() {
    ...
    return (
        <form className='Form' onSubmit={handleSubmit}>
            ...
            <input className='Form_input' name='name' 
            ...
            <input className='Form_input' name='age' 
            ...
            <input className='Form_input' name='cpf' 
            ...
            <input className='Form_input' name='position' 
            ...
            <input className='Form_input' name='salary' 
